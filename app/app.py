...
# subtítulo
st.markdown(
    "Este é um Data App utilizado para exibir a solução de Machine "
    + "Learning para o problema de Human Resource Analytics."
)
...
kmeans_colors = [
    "green" if c == 0 else "red" if c == 1 else "blue"
    for c in model_cluster.labels_
]

st.sidebar.subheader(
    "Defina os atributos do empregado para predição de turnover"
)
...
if btn_predict:
    ...
    plt.scatter(
        x=[satisfaction], y=[evaluation], color="yellow", marker="X", s=300
    )
